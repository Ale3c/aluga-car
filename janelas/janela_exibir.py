...
class ExibirVeiculos(ctk.CTkToplevel):
    def __init__(self, master=None):
        ...
        self.title('Visualisação de Veículos')
        ...
        self.labelTitulo = ctk.CTkLabel(self.frameTitulo, text='Visualizar Veículos', font=('Open Sans', 26, 'bold'), text_color='black')
        ...
        self.style.configure('Treeview', rowheigth=40, font=('Open Sans', 12), foreground='white', background="#2b2b2b")
        self.style.configure('Treeview.Heaging', font=('Open Sans', 12), foregraund="white", backgraound= '#2b2b2b')
        self.style.map('Treeview', backgraud=[('selected', '#144870')])
